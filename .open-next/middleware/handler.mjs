    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__0emy-m4._.js", 74398, (e, t, r) => {
      ...
      var n = { 226: function(t2, r2) {
        !function(n2) {
          ...
          if (J.VERSION = "1.0.35", J.BROWSER = B([c, p, l]), J.CPU = B([f]), J.DEVICE = B([u, h, d, g, v, b, m, y, _]), J.ENGINE = J.OS = B([c, p]), typeof r2 !== a2) t2.exports && (r2 = t2.exports = J), r2.UAParser = J;
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      async function tx(t10) {
        ...
        let _2 = f2.searchParams.get(ed), w2 = new tb({ page: t10.page, input: ((d2 = (c2 = "string" == typeof f2) ? new URL(f2) : f2).searchParams.delete(ed), c2 ? d2.toString() : d2).toString(), init: { body: t10.request.body, headers: v2, method: t10.request.method, nextConfig: t10.request.nextConfig, signal: t10.request.signal } });
      ...
      async function ri(e10, t10) {
        try {
          ...
          let i2 = await crypto.subtle.importKey("raw", new TextEncoder().encode(t10), { name: "HMAC", hash: "SHA-256" }, false, ["verify"]), a2 = Uint8Array.from(atob(n2), (e11) => e11.charCodeAt(0));
          if (!await crypto.subtle.verify("HMAC", i2, a2, new TextEncoder().encode(r2))) return false;
          let o2 = JSON.parse(atob(r2));
          if (o2.exp < Date.now()) return false;
          return "admin" === o2.role;
        } catch {
          return false;
        }
      }
      async function ra(e10) {
        ...
        if (t10.startsWith("/admin") && "/admin/login" !== t10) {
          let t11 = e10.cookies.get(rn)?.value, r3 = process.env.SESSION_SECRET || "sarina-default-session-secret-key-123456";
          if (!(t11 && await ri(t11, r3))) {
            let t12 = e10.nextUrl.clone();
            return t12.pathname = "/admin/login", es.redirect(t12);
          }
        }
        let r2 = t10.startsWith("/api/admin"), n2 = t10.startsWith("/api/orders"), i2 = e10.method;
        if (r2 && "GET" !== i2 || n2 && ("GET" === i2 || t10.split("/").length > 3)) {
          let t11 = e10.cookies.get(rn)?.value, r3 = process.env.SESSION_SECRET || "sarina-default-session-secret-key-123456";
          if (!(t11 && await ri(t11, r3))) return es.json({ error: "Unauthorized access" }, { status: 401 });
        }
        return es.next();
      }

  ...
  ".next/server/edge/chunks/node_modules_next_dist_0o2-izl._.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_next_dist_0o2-izl._.js", 74398, (e, t, r) => {
      ...
      (() => {
        ...
        } }), u = S(972), Object.defineProperty(T, "DiagConsoleLogger", { enumerable: true, get: function() {
          return u.DiagConsoleLogger;
        } }), c = S(957), Object.defineProperty(T, "DiagLogLevel", { enumerable: true, get: function() {
        ...
        } }), v = S(996), Object.defineProperty(T, "SamplingDecision", { enumerable: true, get: function() {
        ...
        } }), _ = S(475), Object.defineProperty(T, "TraceFlags", { enumerable: true, get: function() {
          return _.TraceFlags;
        } }), y = S(98), Object.defineProperty(T, "createTraceState", { enumerable: true, get: function() {
  ...
  `);
      ...
      class U {
        ...
        formatPathname() {
          ...
          }((e10 = { basePath: this[L].basePath, buildId: this[L].buildId, defaultLocale: this[L].options.forceLocale ? void 0 : this[L].defaultLocale, locale: this[L].locale, pathname: this[L].url.pathname, trailingSlash: this[L].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t10 = R(t10)), e10.buildId && (t10 = A(N(t10, `/_next/data/${e10.buildId}`), "/" === e10.pathname ? "index.json" : ".json")), t10 = N(t10, e10.basePath), !e10.buildId && e10.trailingSlash ? t10.endsWith("/") ? t10 : A(t10, "/") : R(t10);
        }
        formatSearch() {
      ...
      var $, q, H, B, V, F, G, z, X, W, K, J, Q, Y, Z, ee = e.i(28042);
      ...
      let eH = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: eB, propagation: eV, trace: eF, SpanStatusCode: eG, SpanKind: ez, ROOT_CONTEXT: eX } = t = e.r(59110);
      class eW extends Error {
        constructor(e10, t10) {
      ...
      let eK = (e10, t10) => {
        ...
        trace(...e10) {
          ...
          return a2.attributes = { "next.span_name": o2, "next.span_type": t10, ...a2.attributes }, eB.with(s2.setValue(eQ, c2), () => this.getTracerInstance().startActiveSpan(o2, a2, (e11) => {
            let r3;
            eH && t10 && e$.has(t10) && (r3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0);
            let n3 = false, o3 = () => {
              !n3 && (n3 = true, eJ.delete(c2), r3 && performance.measure(`${eH}:next-${(t10.split(".").pop() || "").replace(/[A-Z]/g, (e12) => "-" + e12.toLowerCase())}`, { start: r3, end: performance.now() }));
            };
      ...
      async function tx(t10) {
        ...
        let R2 = s2 || es.next(), P2 = R2.headers.get("x-middleware-override-headers"), N2 = [];
        if (P2) {
          for (let [e10, t11] of _2) R2.headers.set(`x-middleware-request-${e10}`, t11), N2.push(e10);
          N2.length > 0 && R2.headers.set("x-middleware-override-headers", P2 + "," + N2.join(","));
        }
        return { response: R2, waitUntil: ("internal" === E2[S].kind ? Promise.all(E2[S].promises).then(() => {
      ...
      let { env: tO, stdout: tR } = (null == (Z = globalThis) ? void 0 : Z.process) ?? {}, tP = tO && !tO.NO_COLOR && (tO.FORCE_COLOR || (null == tR ? void 0 : tR.isTTY) && !tO.CI && "dumb" !== tO.TERM), tN = (e10, t10, r2, n2) => {
      ...
      tA("\x1B[90m", "\x1B[39m"), tA("\x1B[40m", "\x1B[49m"), tA("\x1B[41m", "\x1B[49m"), tA("\x1B[42m", "\x1B[49m"), tA("\x1B[43m", "\x1B[49m"), tA("\x1B[44m", "\x1B[49m"), tA("\x1B[45m", "\x1B[49m"), tA("\x1B[46m", "\x1B[49m"), tA("\x1B[47m", "\x1B[49m"), tL(tk("\u25CB")), tI(tk("\u2A2F")), tj(tk("\u26A0")), tL(tk(" ")), tM(tk("\u2713")), tD(tk("\xBB")), new tT(1e4, (e10) => e10.length), new tT(1e4, (e10) => e10.length);
      ...
      class tY {
        ...
        get readable() {
          return null === this.response ? new ReadableStream({ start(e10) {
            e10.close();
          } }) : "string" == typeof this.response ? tB(this.response) : e7.Buffer.isBuffer(this.response) ? tV(this.response) : Array.isArray(this.response) ? function(...e10) {
        ...
        coerce() {
          return null === this.response ? [] : "string" == typeof this.response ? [tB(this.response)] : Array.isArray(this.response) ? this.response : e7.Buffer.isBuffer(this.response) ? [tV(this.response)] : [this.response];
        }
        pipeThrough(e10) {
      ...
      let rn = "sarina_admin_session";
      async function ri(e10, t10) {
        let r2 = { valid: false, userId: "", role: "" };
        try {
          let [n2, i2] = e10.split(".");
          if (!n2 || !i2) return r2;
          let a2 = await crypto.subtle.importKey("raw", new TextEncoder().encode(t10), { name: "HMAC", hash: "SHA-256" }, false, ["verify"]), o2 = Uint8Array.from(atob(i2), (e11) => e11.charCodeAt(0));
          if (!await crypto.subtle.verify("HMAC", a2, o2, new TextEncoder().encode(n2))) return r2;
          let s2 = JSON.parse(atob(n2));
          if (s2.exp < Date.now()) return r2;
          return { valid: true, userId: s2.userId || "", role: s2.role || "user" };
        } catch {
          return r2;
        }
      }
      async function ra(e10) {
        let { pathname: t10 } = e10.nextUrl, r2 = process.env.SESSION_SECRET || "sarina-default-session-secret-key-123456";
        if (t10.startsWith("/admin")) {
          let t11 = e10.cookies.get(rn)?.value, n3 = t11 ? await ri(t11, r2) : { valid: false, userId: "", role: "" };
          if (!n3.valid || "admin" !== n3.role) {
            let t12 = e10.nextUrl.clone();
            return t12.pathname = "/", es.redirect(t12);
          }
        }
        let n2 = t10.startsWith("/api/admin"), i2 = t10.startsWith("/api/orders"), a2 = e10.method;
        if (n2 && "GET" !== a2 || i2 && ("GET" === a2 || t10.split("/").length > 3)) {
          let t11 = e10.cookies.get(rn)?.value, n3 = t11 ? await ri(t11, r2) : { valid: false, userId: "", role: "" };
          if (!n3.valid || "admin" !== n3.role) return es.json({ error: "Unauthorized access" }, { status: 401 });
        }
        return es.next();
      }
      e.s(["config", 0, { matcher: ["/admin/:path*", "/api/admin/:path*", "/api/orders/:path*"] }, "middleware", 0, ra], 96592);
      let ro = { ...e.i(96592) }, rs = "/middleware", rl = ro.middleware || ro.default;
      if ("function" != typeof rl) throw new class extends Error {
        constructor(e10) {
          super(e10), this.stack = "";
        }
      }(`The Middleware file "${rs}" must export a function named \`middleware\` or a default function.`);
      let ru = (e10) => tx({ ...e10, IncrementalCache: rr, incrementalCacheHandler: null, page: rs, handler: async (...e11) => {
        try {
          return await rl(...e11);
        } catch (i2) {
      ...
      async function rc(e10, t10) {
        let r2 = await ru({ request: { url: e10.url, method: e10.method, headers: w(e10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: rs }, body: "GET" !== e10.method && "HEAD" !== e10.method ? e10.body ?? void 0 : void 0, waitUntil: t10.waitUntil, requestMeta: t10.requestMeta, signal: t10.signal || new AbortController().signal } });
        return null == t10.waitUntil || t10.waitUntil.call(t10, r2.waitUntil), r2.response;
      }
      e.s(["default", 0, ru, "handler", 0, rc], 58217);
    }]);
  }
});
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/orders(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "typescript": { "ignoreBuildErrors": false }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.mjs", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [{ "protocol": "https", "hostname": "**" }], "qualities": [75], "unoptimized": true, "customCacheHandler": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": { "serverFunctions": true, "browserToTerminal": "warn" }, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "C:\\Users\\ytusu\\Downloads\\sarinashoe", "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "appNewScrollHandler": false, "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "cachedNavigations": false, "partialFallbacks": false, "dynamicOnHover": false, "varyParams": false, "prefetchInlining": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 15, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "strictRouteTypes": false, "viewTransition": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": true, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "gestureTransition": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": "warn", "lockDistDir": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": true, "turbopackPluginRuntimeStrategy": "childProcesses", "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.mjs", "turbopack": { "root": "C:\\Users\\ytusu\\Downloads\\sarinashoe" }, "distDirRoot": ".next" };
var BuildId = "hcsl8u05-QqoNPCM7pQK5";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/brands", "regex": "^/admin/brands(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/brands(?:/)?$" }, { "page": "/admin/login", "regex": "^/admin/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/login(?:/)?$" }, { "page": "/admin/orders", "regex": "^/admin/orders(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/orders(?:/)?$" }, { "page": "/admin/products", "regex": "^/admin/products(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/products(?:/)?$" }, { "page": "/api/admin/brands", "regex": "^/api/admin/brands(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/brands(?:/)?$" }, { "page": "/api/admin/products", "regex": "^/api/admin/products(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/products(?:/)?$" }, { "page": "/api/auth/login", "regex": "^/api/auth/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/login(?:/)?$" }, { "page": "/api/auth/me", "regex": "^/api/auth/me(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/me(?:/)?$" }, { "page": "/api/auth/register", "regex": "^/api/auth/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/register(?:/)?$" }, { "page": "/api/orders", "regex": "^/api/orders(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/orders(?:/)?$" }, { "page": "/products", "regex": "^/products(?:/)?$", "routeKeys": {}, "namedRegex": "^/products(?:/)?$" }], "dynamic": [{ "page": "/api/admin/brands/[id]", "regex": "^/api/admin/brands/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/brands/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/products/[id]", "regex": "^/api/admin/products/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/products/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/orders/[id]", "regex": "^/api/orders/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/orders/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/products/[id]", "regex": "^/products/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/products/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/brands": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/brands", "dataRoute": "/admin/brands.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/login", "dataRoute": "/admin/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/orders": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/orders", "dataRoute": "/admin/orders.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/products": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/products", "dataRoute": "/admin/products.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "94d832bc0f5593633ff83ee95520b67c", "previewModeSigningKey": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf", "previewModeEncryptionKey": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/[root-of-the-server]__1osrt2u._.js", "server/edge/chunks/node_modules_next_dist_0o2-izl._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0bjtjym.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0bjtjym.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/api/admin/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api\\/orders(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/api/orders/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } } }, "sortedMiddleware": ["/"], "functions": { "/admin/page": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/next-font-manifest.js", "server/server-reference-manifest.js", "server/edge/chunks/ssr/_0rzl25z._.js", "server/edge/chunks/ssr/node_modules_1d7e6ux._.js", "server/edge/chunks/ssr/src_components_layout_ClientLayout_tsx_0tgs4t9._.js", "server/edge/chunks/ssr/node_modules_next_dist_1xc97ap._.js", "server/edge/chunks/ssr/node_modules_next_dist_1b838cn._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_1zxnqeb._.js", "server/edge/chunks/ssr/node_modules_lucide-react_dist_esm_icons_shopping-bag_1-50-e_.js", "server/edge/chunks/ssr/node_modules_03oxun-._.js", "server/edge/chunks/ssr/node_modules_next_dist_0iea_qs._.js", "server/edge/chunks/ssr/_1yiwtsd._.js", "server/app/admin/page_client-reference-manifest.js", "server/edge/chunks/ssr/_next-internal_server_app_admin_page_actions_0ts4hnk.js", "server/edge/chunks/ssr/node_modules_0o03eks._.js", "server/edge/chunks/ssr/node_modules_next_dist_059m72z._.js", "server/edge/chunks/ssr/[root-of-the-server]__00j14zv._.js", "server/edge/chunks/ssr/_0y40l49._.js", "server/edge/chunks/ssr/node_modules_next_dist_197afnr._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_0sdtsz7._.js", "server/edge/chunks/ssr/node_modules_next_dist_1780s3v._.js", "server/edge/chunks/ssr/node_modules_next_dist_compiled_0czwz5q._.js", "server/edge/chunks/ssr/node_modules_next_dist_0hvoqp9._.js", "server/edge/chunks/ssr/[root-of-the-server]__1wdbuq1._.js", "server/edge/chunks/ssr/_1-q1wme._.js", "server/edge/chunks/ssr/node_modules_0snrk9m._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_build_templates_edge-ssr-app_11wedij.js", "server/edge/chunks/ssr/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1kc6_mw.js", "server/app/admin/page/react-loadable-manifest.js"], "name": "app/admin/page", "page": "/admin/page", "entrypoint": "server/edge/chunks/ssr/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1kc6_mw.js", "matchers": [{ "regexp": "^/admin(?:/)?$", "originalSource": "/admin" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/admin/brands/[id]/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/admin/brands/[id]/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_admin_brands_[id]_route_actions_1y-x_84.js", "server/edge/chunks/[root-of-the-server]__0dxy-rs._.js", "server/edge/chunks/_1e66auh._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_05gcczq.js"], "name": "app/api/admin/brands/[id]/route", "page": "/api/admin/brands/[id]/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_05gcczq.js", "matchers": [{ "regexp": "^/api/admin/brands/(?P<nxtPid>[^/]+?)(?:/)?$", "originalSource": "/api/admin/brands/[id]" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/admin/brands/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/admin/brands/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_admin_brands_route_actions_18dc5vc.js", "server/edge/chunks/[root-of-the-server]__1rnlq8o._.js", "server/edge/chunks/_1-u3o2j._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1wfo9ke.js"], "name": "app/api/admin/brands/route", "page": "/api/admin/brands/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1wfo9ke.js", "matchers": [{ "regexp": "^/api/admin/brands(?:/)?$", "originalSource": "/api/admin/brands" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/admin/products/[id]/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/admin/products/[id]/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_admin_products_[id]_route_actions_0_6uawj.js", "server/edge/chunks/[root-of-the-server]__0ga2knw._.js", "server/edge/chunks/_1e66auh._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0c-ug-c.js"], "name": "app/api/admin/products/[id]/route", "page": "/api/admin/products/[id]/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0c-ug-c.js", "matchers": [{ "regexp": "^/api/admin/products/(?P<nxtPid>[^/]+?)(?:/)?$", "originalSource": "/api/admin/products/[id]" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/admin/products/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/admin/products/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_admin_products_route_actions_01tq6ik.js", "server/edge/chunks/[root-of-the-server]__0z-s69j._.js", "server/edge/chunks/_1-u3o2j._.js", "server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-app-route_0k5_1h4.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0or730n.js"], "name": "app/api/admin/products/route", "page": "/api/admin/products/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0or730n.js", "matchers": [{ "regexp": "^/api/admin/products(?:/)?$", "originalSource": "/api/admin/products" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/auth/login/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/auth/login/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_auth_login_route_actions_08uv61n.js", "server/edge/chunks/[root-of-the-server]__1910rkh._.js", "server/edge/chunks/_1-u3o2j._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1n2veu5.js"], "name": "app/api/auth/login/route", "page": "/api/auth/login/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1n2veu5.js", "matchers": [{ "regexp": "^/api/auth/login(?:/)?$", "originalSource": "/api/auth/login" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/auth/me/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/auth/me/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_auth_me_route_actions_096csan.js", "server/edge/chunks/[root-of-the-server]__1mz2fkv._.js", "server/edge/chunks/_1-u3o2j._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1r0y0t9.js"], "name": "app/api/auth/me/route", "page": "/api/auth/me/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1r0y0t9.js", "matchers": [{ "regexp": "^/api/auth/me(?:/)?$", "originalSource": "/api/auth/me" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/auth/register/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/auth/register/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_auth_register_route_actions_1m77dok.js", "server/edge/chunks/[root-of-the-server]__071pz6i._.js", "server/edge/chunks/_1-u3o2j._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0b7smai.js"], "name": "app/api/auth/register/route", "page": "/api/auth/register/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0b7smai.js", "matchers": [{ "regexp": "^/api/auth/register(?:/)?$", "originalSource": "/api/auth/register" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/orders/[id]/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/orders/[id]/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_orders_[id]_route_actions_14okgfl.js", "server/edge/chunks/[root-of-the-server]__1s92hit._.js", "server/edge/chunks/_1e66auh._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1ybjhul.js"], "name": "app/api/orders/[id]/route", "page": "/api/orders/[id]/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1ybjhul.js", "matchers": [{ "regexp": "^/api/orders/(?P<nxtPid>[^/]+?)(?:/)?$", "originalSource": "/api/orders/[id]" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/api/orders/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/orders/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_orders_route_actions_12bmtif.js", "server/edge/chunks/[root-of-the-server]__09jljzy._.js", "server/edge/chunks/_1e66auh._.js", "server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-app-route_1v6qfip.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0p_q1an.js"], "name": "app/api/orders/route", "page": "/api/orders/route", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0p_q1an.js", "matchers": [{ "regexp": "^/api/orders(?:/)?$", "originalSource": "/api/orders" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/products/[id]/page": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/next-font-manifest.js", "server/server-reference-manifest.js", "server/edge/chunks/ssr/_0rzl25z._.js", "server/edge/chunks/ssr/node_modules_1d7e6ux._.js", "server/edge/chunks/ssr/src_components_layout_ClientLayout_tsx_0tgs4t9._.js", "server/edge/chunks/ssr/node_modules_next_dist_1xc97ap._.js", "server/edge/chunks/ssr/node_modules_next_dist_1b838cn._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_1zxnqeb._.js", "server/edge/chunks/ssr/node_modules_lucide-react_dist_esm_icons_shopping-bag_1-50-e_.js", "server/edge/chunks/ssr/node_modules_03oxun-._.js", "server/edge/chunks/ssr/node_modules_next_dist_0iea_qs._.js", "server/edge/chunks/ssr/src_app_products_[id]_ProductDetailClient_tsx_1yoaut7._.js", "server/app/products/[id]/page_client-reference-manifest.js", "server/edge/chunks/ssr/_next-internal_server_app_products_[id]_page_actions_1m0z4ia.js", "server/edge/chunks/ssr/node_modules_0o03eks._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_0sdtsz7._.js", "server/edge/chunks/ssr/[root-of-the-server]__1-7s6mn._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_build_templates_edge-ssr-app_0xhsxfz.js", "server/edge/chunks/ssr/node_modules_next_dist_059m72z._.js", "server/edge/chunks/ssr/node_modules_0snrk9m._.js", "server/edge/chunks/ssr/_0o_1da6._.js", "server/edge/chunks/ssr/node_modules_next_dist_197afnr._.js", "server/edge/chunks/ssr/node_modules_next_dist_0hvoqp9._.js", "server/edge/chunks/ssr/[root-of-the-server]__1wdbuq1._.js", "server/edge/chunks/ssr/node_modules_next_dist_1780s3v._.js", "server/edge/chunks/ssr/node_modules_next_dist_compiled_0czwz5q._.js", "server/edge/chunks/ssr/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_02dzhej.js", "server/app/products/[id]/page/react-loadable-manifest.js"], "name": "app/products/[id]/page", "page": "/products/[id]/page", "entrypoint": "server/edge/chunks/ssr/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_02dzhej.js", "matchers": [{ "regexp": "^/products/(?P<nxtPid>[^/]+?)(?:/)?$", "originalSource": "/products/[id]" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } }, "/products/page": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/next-font-manifest.js", "server/server-reference-manifest.js", "server/edge/chunks/ssr/_0rzl25z._.js", "server/edge/chunks/ssr/node_modules_1d7e6ux._.js", "server/edge/chunks/ssr/src_components_layout_ClientLayout_tsx_0tgs4t9._.js", "server/edge/chunks/ssr/node_modules_next_dist_1xc97ap._.js", "server/edge/chunks/ssr/node_modules_next_dist_1b838cn._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_1zxnqeb._.js", "server/edge/chunks/ssr/node_modules_lucide-react_dist_esm_icons_shopping-bag_1-50-e_.js", "server/edge/chunks/ssr/node_modules_03oxun-._.js", "server/edge/chunks/ssr/node_modules_next_dist_0iea_qs._.js", "server/edge/chunks/ssr/node_modules_lucide-react_dist_esm_icons_tag_0ebawce.js", "server/edge/chunks/ssr/src_app_products_ProductListingClient_tsx_1ozv717._.js", "server/app/products/page_client-reference-manifest.js", "server/edge/chunks/ssr/_next-internal_server_app_products_page_actions_1jx7f2w.js", "server/edge/chunks/ssr/node_modules_0o03eks._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_0sdtsz7._.js", "server/edge/chunks/ssr/[root-of-the-server]__0zu4cxq._.js", "server/edge/chunks/ssr/node_modules_next_dist_197afnr._.js", "server/edge/chunks/ssr/node_modules_next_dist_esm_build_templates_edge-ssr-app_1oxt7i9.js", "server/edge/chunks/ssr/node_modules_next_dist_059m72z._.js", "server/edge/chunks/ssr/node_modules_next_dist_1780s3v._.js", "server/edge/chunks/ssr/node_modules_next_dist_0hvoqp9._.js", "server/edge/chunks/ssr/[root-of-the-server]__1wdbuq1._.js", "server/edge/chunks/ssr/_1-q1wme._.js", "server/edge/chunks/ssr/node_modules_0snrk9m._.js", "server/edge/chunks/ssr/node_modules_next_dist_compiled_0czwz5q._.js", "server/edge/chunks/ssr/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1eb1r4_.js", "server/app/products/page/react-loadable-manifest.js"], "name": "app/products/page", "page": "/products/page", "entrypoint": "server/edge/chunks/ssr/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_1eb1r4_.js", "matchers": [{ "regexp": "^/products(?:/)?$", "originalSource": "/products" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hcsl8u05-QqoNPCM7pQK5", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "lVPVmMogLaQHnbiY/UrfTiKcA+dTfA/lz1wyjhulKNE=", "__NEXT_PREVIEW_MODE_ID": "94d832bc0f5593633ff83ee95520b67c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "eb96c5eb44aa3f05ef8b03ea559ea9bbf7dce22c2356009a34883fcebf7c2be7", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "14346258c9cd515a36edd847c207fb3ac85422ecf4f16009c77ee988adf487bf" } } } };
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/admin/brands/page": "/admin/brands", "/admin/login/page": "/admin/login", "/admin/orders/page": "/admin/orders", "/admin/page": "/admin", "/admin/products/page": "/admin/products", "/api/admin/brands/[id]/route": "/api/admin/brands/[id]", "/api/admin/brands/route": "/api/admin/brands", "/api/admin/products/[id]/route": "/api/admin/products/[id]", "/api/admin/products/route": "/api/admin/products", "/api/auth/login/route": "/api/auth/login", "/api/auth/me/route": "/api/auth/me", "/api/auth/register/route": "/api/auth/register", "/api/orders/[id]/route": "/api/orders/[id]", "/api/orders/route": "/api/orders", "/page": "/", "/products/[id]/page": "/products/[id]", "/products/page": "/products" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/admin": {}, "/api/admin/brands": {}, "/api/admin/brands/[id]": {}, "/api/admin/products": {}, "/api/admin/products/[id]": {}, "/api/auth/login": {}, "/api/auth/me": {}, "/api/auth/register": {}, "/api/orders": {}, "/api/orders/[id]": {}, "/products": {}, "/products/[id]": {} } };

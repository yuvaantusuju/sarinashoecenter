...
export async function optimizeImage(headers, imageParams, nextConfig, handleRequest) {
    ...
    const isV15After15510 = compareSemver(globalThis.nextVersion, ">=", "15.5.10") &&
        compareSemver(globalThis.nextVersion, "<", "16");
    const isV15After15515 = compareSemver(globalThis.nextVersion, ">=", "15.5.16") &&
        compareSemver(globalThis.nextVersion, "<", "16");
    ...
    const maximumResponseBody = nextConfig.images?.maximumResponseBody || 50_000_000;
    const imageUpstream = isAbsolute
        ...
        : await (isNewArgsForInternalFetch
            ...
            maximumResponseBody, handleRequest)
            : // @ts-expect-error - fetchInternalImage signature has changed in Next.js 15.5.16 and 16.2.5
                fetchInternalImage(href, { headers }, {}, // res object is not necessary as it's not actually used.
                handleRequest));

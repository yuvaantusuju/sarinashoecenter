 ...
 */
export async function patchOriginalNextConfig(options) {
    ...
    const manifestStandalonePath = path.join(options.appBuildOutputPath, ".next/standalone", buildHelper.getPackagePath(options), ".next/required-server-files.json");
 ...
 * @returns
 */
async function importNextConfigFromSource(buildOptions) {

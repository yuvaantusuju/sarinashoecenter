...
import { loadFunctionsConfigManifest, loadMiddlewareManifest, } from "../adapters/config/util.js";
 ...
 */
export async function createMiddleware(options, { forceOnlyBuildOnce = false } = {}) {
    ...
    const edgeMiddlewareInfo = middlewareManifest.middleware["/"];

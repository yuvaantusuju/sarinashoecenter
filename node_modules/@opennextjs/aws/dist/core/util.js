import { AppPathsManifestKeys, NextConfig, RoutesManifest, } from "../adapters/config/index.js";
// @ts-ignore
import NextServer from "next/dist/server/next-server.js";
import { debug, error } from "../adapters/logger.js";
import { applyOverride as applyNextjsRequireHooksOverride, overrideHooks as overrideNextjsRequireHooks, } from "./require-hooks.js";
...
globalThis.__next_route_preloader = async (stage) => {
    ...
    else if ((stage === "start" && routePreloadingBehavior === "onStart") ||
...
export const requestHandler = (metadata) => "getRequestHandlerWithMetadata" in nextServer
    ? nextServer.getRequestHandlerWithMetadata(metadata)
    : nextServer.getRequestHandler();
//#override setNextjsPrebundledReact
export function setNextjsPrebundledReact(rawPath) {
